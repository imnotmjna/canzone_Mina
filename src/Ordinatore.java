...
public class Ordinatore 
{
    ...
    /**
     * Scambia la canzone in posizione pos1 con
     * la canzone in posizione pos2 
     * dell' array di libri a
     * @param a
     * @param pos1
     * @param pos2 
     */
    public static void scambiaCanzoni(Canzone[] a, int pos1, int pos2)
    {
        Canzone s;
        s=a[pos1];
        a[pos1]=a[pos2];
     ...
     * @return  una copia dell'array ordinato
     */
    public static Canzone[] selectionSortCrescenteCanzoni (Canzone[] a)
    {
        Canzone v[]= new Canzone[a.length];
        int lunghezza=v.length;
        //creo una copia di a
        for(int i=0;i<v.length;i++)
        {
