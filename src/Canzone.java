...
public class Canzone implements Serializable
{
     ...
     * @param cantante Il cantante della canzone
     ...
     */
    public Canzone(String titolo,String cantante, int durata, long idCanzone, LocalDate dataUscita) 
    {
        this.titolo = titolo;
    ...
    public Canzone (Canzone canzone)
    {
        ...
        this.cantante=canzone.getCantante();
