            ...
            switch (voceScelta) 
            {
                ...
                case 2://aggiungiCanzone    
                    try
                    {
                        ...
                        do
                        {
                            try
                            {
                                System.out.print("Posizione (0..49): ");
                        ...
                        do {
                                try 
                                {
                                    System.out.print("Inserisci la data di uscita (AAAA-MM-GG): ");
                        ...
                        try
                        {
                            try 
                            {
                                p1.setCanzone(new Canzone(titolo, cantante, durata, idCanzone, dataUscita),posizione);
                            } 
                ...
                case 5:
                    try 
                    {
                        ...
                        {
                            System.out.println("Canzoni presenti: ");
                ...
                case 9:
                    ...
                    break;
                case 10://carica playlist 
                    try 
                    {
                        p1.caricaPlaylist(nomeFileBinario);
